  ...
  return (
    ...
    <div className='w-[18vw] min-w-50 h-80 relative bg-white rounded-xl overflow-hidden'>
        ...
        <div id='bottom' className=' w-full px-4 py-6  text-white absolute bottom-0 flex justify-between  items-center gap-2'>
            ...
            <h2 className='text-[16px] md:text-[18px] lg:text-[20px] font-semibold capitalize h-14 flex items-center overflow-hidden leading-tight'>
              {item.title}
            </h2>  
            <button className='bg-indigo-600 text-white rounded px-3 py-2 cursor-pointer font-medium text-[14px] shrink-0 active:scale-95'>
              Save
            </button>       
        </div>
